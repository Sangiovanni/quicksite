...
The 172 commands group into the categories below. Use `GET /management/help` for the full per-command spec.
...
- The whitelist of valid commands is `secure/management/routes.php` (172 entries — this file is the single source of truth for which commands exist).
