...
returns full documentation for **all 126 commands** — parameters, examples, validation rules, and error codes. For a specific command:
...
The 126 commands group into the categories below. Use `GET /management/help` for the full per-command spec.
...
- The whitelist of valid commands is `secure/management/routes.php` (126 entries — this file is the single source of truth for which commands exist).
