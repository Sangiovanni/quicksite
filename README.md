...
- **RESTful Management API**: 107 endpoints for complete site management
...
| Role | Access |
|------|--------|
| `viewer` | Read-only (30 commands): get*, list*, help, API read |
| `editor` | Content editing (64 commands): edit*, add*, delete content, interactions, APIs |
| `designer` | Styling (71 commands): CSS, styles, visual design, APIs |
| `developer` | Build & deploy (78 commands): build, deploy, downloads, AI |
| `admin` | Full admin (99 commands): everything except token/role management |
| `*` (superadmin) | Full access (107 commands) including token and role management |
