...
$content = '';
$content .= "<h1>";
$content .= htmlspecialchars($translator->translate('404.pageNotFound'), ENT_QUOTES | ENT_HTML5, 'UTF-8');
$content .= "</h1>";
$content .= "<div class=\"" . htmlspecialchars('center', ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\">";
$content .= htmlspecialchars($translator->translate('404.message'), ENT_QUOTES | ENT_HTML5, 'UTF-8');
$content .= "</div>";
$content .= "<div class=\"" . htmlspecialchars('center', ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\">";
$content .= "<img src=\"" . htmlspecialchars(processUrl('/assets/images/404.png', $__lang), ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\" alt=\"" . htmlspecialchars('404 Image', ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\" class=\"" . htmlspecialchars('img-fluid', ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\">";
$content .= "</div>";

require_once SECURE_FOLDER_PATH . '/src/classes/Page.php';
$page = new Page('Page Not Found', $content, $lang);
$page->render();
