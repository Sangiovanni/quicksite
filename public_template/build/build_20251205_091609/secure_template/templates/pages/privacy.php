...
$content = '';
$content .= "<h1>";
$content .= htmlspecialchars($translator->translate('privacy.title'), ENT_QUOTES | ENT_HTML5, 'UTF-8');
$content .= "</h1>";
$content .= "<div class=\"" . htmlspecialchars('center', ENT_QUOTES | ENT_HTML5, 'UTF-8') . "\">";
$content .= htmlspecialchars($translator->translate('privacy.content'), ENT_QUOTES | ENT_HTML5, 'UTF-8');
$content .= "</div>";

require_once SECURE_FOLDER_PATH . '/src/classes/Page.php';
$page = new Page('Privacy', $content, $lang);
$page->render();
