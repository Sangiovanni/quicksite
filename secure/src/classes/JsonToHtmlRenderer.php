    ...
    private function transformCallSyntax(string $value): string {
        ...
        return preg_replace_callback(
            ...
            function ($matches) {
                ...
                // Split on commas NOT preceded by a backslash so a single arg
                // can contain a literal comma (escaped as "\,"). Then unescape
                // "\," → "," before quoting. Generated by generateCallSyntax().
