...
$renderer = new JsonToHtmlRenderer($translator, ['lang' => $lang, 'page' => 'get-started']);

$content = $renderer->renderPage('get-started');

require_once SECURE_FOLDER_PATH . '/src/classes/PageManagement.php';

// Get page title from translation
$pageTitle = $translator->translate('page.titles.get-started');
