...
<?php /* The two-tab strip that used to sit here is gone with the history tab.
         A one-item tab strip is noise, and a "tab" that navigates to a different
...
<script src="<?= $baseUrl ?>/admin/assets/js/pages/command.js?v=<?= filemtime(ADMIN_ASSET_ROOT . '/admin/assets/js/pages/command.js') ?>"></script>
