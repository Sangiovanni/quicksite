...
window.PreviewConfig = {
    ...
    i18nPanels: {
        ...
        aiTools: {
            ...
            importSuccess: <?= json_encode(__admin('preview.aiToolsImportSuccess', 'Imported "{id}"')) ?>,
            importFailed: <?= json_encode(__admin('preview.aiToolsImportFailed', 'Import failed: {error}')) ?>,
            importInvalid: <?= json_encode(__admin('preview.aiToolsImportInvalid', "Selected file isn't a valid workflow JSON.")) ?>,
            deleteCustomTitle: <?= json_encode(__admin('preview.aiToolsDeleteCustomTitle', 'Delete this custom workflow')) ?>,
            deleteCustomConfirm: <?= json_encode(__admin('preview.aiToolsDeleteCustomConfirm', 'Delete custom workflow "{title}"? Its JSON, prompt template, and translations sidecar will be removed.')) ?>,
            deleteCustomSuccess: <?= json_encode(__admin('preview.aiToolsDeleteCustomSuccess', 'Deleted "{id}"')) ?>,
            deleteCustomFailed: <?= json_encode(__admin('preview.aiToolsDeleteCustomFailed', 'Delete failed: {error}')) ?>,
