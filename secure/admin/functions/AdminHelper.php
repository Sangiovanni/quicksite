...
function getCommandCategories(): array {
    ...
    return [
        'route_management' => [
            ...
            'icon' => 'route',
            'commands' => ['addRoute', 'deleteRoute', 'setRouteLayout', 'setRouteResolver', 'getRoutes', 'getSiteMap', 'analyzeReachability']
        ],
        ...
        'privacy_registry' => [
            'label' => 'Privacy',
            'icon' => 'shield',
            'commands' => ['getPrivacyStatus', 'setCollectedDatum', 'deleteCollectedDatum', 'setPrivacyDescLang', 'setPrivacyMapping', 'setPrivacyHost']
        ],
        'snippet_management' => [
            'label' => 'Snippets',
            'icon' => 'puzzle',
